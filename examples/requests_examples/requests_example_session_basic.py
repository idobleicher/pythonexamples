...
# If you need to fine-tune your control over how requests are being made or
# improve the performance of your requests, you may need to use a Session instance directly.

#Sessions are used to persist parameters across requests.
# For example, if you want to use the same authentication across multiple requests, you could use a session:
...
#Each time you make a request with session, once it has been initialized with authentication credentials,
# the credentials will be persisted.
...
# When your app wants to connect to the same server again, it will reuse a connection
# from the pool rather than establishing a new one.
