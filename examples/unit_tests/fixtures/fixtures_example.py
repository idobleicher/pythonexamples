...
# if running test_1_that_needs_resource_a/test_3_that_does - resources_a_setup() and resource_a_teardown are running
#if running test_2_that_does_not  - setup + teardown not running
